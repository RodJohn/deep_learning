...
class DeepModel:
    ...
    def deep(self):
        ...
        self.weights['feats_emb'] = tf.concat((tf.zeros(shape=[1, self.embedding_size]), self.weights['feats_emb'][1:]), 0)
        ...
        with tf.name_scope('deep_part'):
            ...
            # concat continuity & vector & category_embedding & multi_category_embedding -> Dense Vector
            dense_vector = tf.concat([self.cont_feats, self.vector_feats, self.cate_emb, self.all_multi_cate_emb],
            ...
            input_size = self.cont_field_size + self.vector_feats_size + cate_emb_size + multi_cate_emb_size
